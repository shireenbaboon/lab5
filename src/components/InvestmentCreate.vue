                ...
                <form ref="form">
                  <div class="container-fluid">
                    ...
                    <div class="form-group row justify-content-around py-2"><label class="col-4">Category</label>
                      <div class="col col-8">
                        <input v-model="investment.category" type="text" class="form-control-sm
form-control"></div>
                    </div>
                    <div class="form-group row justify-content-around py-2"><label class="col-4">Description</label>
                      <div class="col col-8">
                        <input v-model="investment.description" type="text" class="form-control-sm
form-control"></div>
                    </div>
                    ...
                    <div class="form-group row justify-content-around py-2"><label class="col-4">Recent Date</label>
                      <div class="col col-8">
                        <input v-model="investment.recent_date" type="date" class="form-control-sm
form-control"></div>
                    </div>
                    <div class="row justify-content-around">
                      <div v-if="!isUpdate" type="button" class="btn btn-primary col-4"
                           @click="createInvestment">Save
                      </div>
                      <div v-if="isUpdate" type="button" class="btn btn-primary col-4"
                           @click="updateInvestment">Update
                      </div>
...
export default {
  name: 'InvestmentCreate', components: {},
  data() {
    return {
      customers: [], showError: false,
      investment: {},
      pageTitle: "Add New Investment", isUpdate: false,
      showMsg: '',
      date: new Date()
    };
  },
