        ...
        <div class="card" v-for="stock in stocks" v-bind:key="stock">
          <div class="card-header" :id="'heading' + stock.pk">
            <button class="btn btn-link collapsed" data-bs-toggle="collapse" :data-bs-target="'#collapse' + stock.pk"
              ...
              <h6 style="color: #0275d8; float: left">{{ stock.cust_number }}</h6></button>
          </div>
          <div :id="'collapse' + stock.pk" class="collapse" :aria-labelledby="'heading' + stock.pk"
            ...
            <div class="card-body">
              <p><b>Customer #:</b> {{ stock.cust_number }}</p>,
                ...
                <p><b>Purchase Date:</b> {{ stock.purchase_date }}
              </p>
              <div class="btn-group">
                <button @click="updateStock(stock)" style="background-color: transparent; padding: 0;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                       class="bi bi-pencil" viewBox="0 0 16 16">
                    <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.54.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                  </svg>
                </button>
                <button @click="deleteStock(stock)" style="background-color:transparent; padding: 0;">
                  <svg @click="deleteStock" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                    ...
                    2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                  </svg>
                </button>
              </div>
            </div>
...
10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
            ...
            <td @click="deleteStock(stock)">
              <button style="background-color: transparent; padding: 0;">
                <svg @click="deleteStock" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
export default {
  name: "StockList", data: () => ({
    stocks: [],
    validUserName: "Guest", stockSize: 0, showMsg: '', isMobile: false, headers: [
