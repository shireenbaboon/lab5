        ...
        <table class="table table-hover" style="overflow-y: auto" :headers="headers">
          ...
          <tr v-for="investment in investments" v-bind:key="investment">
            ...
            <td @click="deleteInvestment(investment)">
              <button style="background-color: transparent; padding: 0;">
                <svg @click="deleteInvestment" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
export default {
  name: "InvestmentList", data: () => ({
    investments: [], validUserName: "Guest", investmentSize: 0, showMsg: '',
    isMobile: false,
    headers: [
      {text: 'Customer Number', sortable: false, align: 'left',}, {text: 'Category', sortable: false, align: 'left',},
