          ...
          <div :id="'collapse' + customer.pk" class="collapse" :aria-labelledby="'heading' + customer.pk"
            ...
            <div class="card-body">
              ...
              <p><b>Address:</b> <br/> {{ customer.address }}, <br/> {{ customer.city }},
                <br/> {{ customer.state }} {{ customer.zipcode }}</p>
...
10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
            ...
            <td @click="deleteCustomer(customer)">
              <button style="background-color: transparent; padding: 0;">
                <svg @click="deleteCustomer" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  name: "CustomerList", data: () => ({
    ...
    validUserName: "Guest", customerSize: 0, showMsg: '', isMobile: false, headers: [
      ...
      {text: 'State', sortable: false, align: 'left',}, {
        ...
        sortable: false,
        align: 'left',
      }, {text: 'Update', sortable: false, align: 'left',}, {text: 'Delete', sortable: false, align: 'left',}
    ],
  }), mounted() {
    this.getCustomers();
    this.showMessages();
